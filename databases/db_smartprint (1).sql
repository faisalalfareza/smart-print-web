...
--
-- Host: 127.0.0.1
-- Generation Time: 03 Nov 2018 pada 05.29
...
(187, 'testing@gmail.com', '$2a$08$tsmm8dhCEGl1yi8m25mP7eQobxXINCsXI2q3l3CN3yd8YbK0Yqiza', '1', 2),
(184, 'print@gmail.com', '$2a$08$eYWtwFItsQnEIoCuGqECnOxZgF6erQt1VNhLCWwRG7hDocdvRkLZi', '1', 3),
(176, 'fan@gmail.com', '$2a$08$vBHDUw9WGhZndFQ/XqXRN.A2FFGbQvwtm7BNoMeqD7kYtEIMxPEei', '1', 2);
...
--
ALTER TABLE `ms_user`
  MODIFY `UserId` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=188;
--
-- AUTO_INCREMENT for table `tr_document_detail`
--
ALTER TABLE `tr_document_detail`
  MODIFY `DocumentId` int(20) NOT NULL AUTO_INCREMENT;
--
